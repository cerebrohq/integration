...
import py_cerebro2
from py_cerebro2 import dbtypes # в этом модуле описаны различные константы, такие как поля данных, флаги и т.п.
...
project_name = '_Test Project_' # Имя проекта для тестового добавления задач. 
...
def create_and_link_tasks(db_user,  db_password):
	...
	Описание всех функций смотрите в модуле database пакета py_cerebro2.
	...
	try:
		...
		db = py_cerebro2.database.Database(database_host, database_port)
		...
		carga = py_cerebro2.cargador.Cargador(cargador_host, cargador_xmlrpc_port,  cargador_http_port)
...
create_and_link_tasks("Pchelin",  "Qwert12345")